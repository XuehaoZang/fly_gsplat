...
from utils.seg2d import load_sparse_frame, segment_body_wing
...
def main():
    ...
    parser.add_argument("--out-dir", type=str, default="outputs/seg2d_debug")
